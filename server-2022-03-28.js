...
function set_routes(server, db_connection) {
        ...
        handler: async function (request, reply) {
            ...
            return await new Promise((resolve, reject) => {
                ...
                const request = new Request(
                    `select password, users_id from users_pass where users_id = (
                ...
                request.on('doneProc', function (rowCount, more, returnStatus, rows) {
                    console.log(true_password, " equals ", password)
                    return resolve(true_password == password?userId:-1);
                });
    ...
    // SELECT * FROM [dbo].[bar_drink_view] WHERE bar_id = ${bar_id}
    server.route({
        method: 'GET',
        //Takes in user id as a param through path
        ...
        handler: async function (request, reply) {
            ...
            const query = `SELECT * FROM [dbo].[bar_drink_view] WHERE bar_id = ${bar_id}`;
            console.log(query);
            return await new Promise((resolve, reject) => {
                const request = new Request(query,
                    (err, rowCount) => {
    ...
    // SELECT * FROM [dbo].[user_bar_drink_view] WHERE user_id=${user_id} AND bar_id = ${bar_id}
    server.route({
        method: 'GET',
        //Takes in user id as a param through path
        path: '/userBarDrink/{user_id}/{bar_id}',
        handler: async function (request, reply) {
            const user_id = request.params.user_id;
            const bar_id = request.params.bar_id;
            const query = `SELECT drink_name FROM [dbo].[user_bar_drink_view] WHERE user_id=${user_id} AND bar_id = ${bar_id}`;
            console.log(query);
            return await new Promise((resolve, reject) => {
                const request = new Request(query,
                    (err, rowCount) => {
    ...
    // SELECT  * FROM [dbo].[user_bar_tab_view] WHERE user_id=${user_id} AND bar_id=${bar_id} AND tab_id=${tab_id}
    server.route({
        method: 'GET',
        //Takes in user id as a param through path
        path: '/userBarTab/{user_id}/{bar_id}/{tab_id}',
        handler: async function (request, reply) {
            const user_id = request.params.user_id;
            const bar_id = request.params.bar_id;
            const tab_id = request.params.tab_id;

            const query = `SELECT  * FROM [dbo].[user_bar_tab_view] WHERE user_id=${user_id} AND bar_id=${bar_id} AND tab_id=${tab_id}`;
            console.log(query);
            return await new Promise((resolve, reject) => {
                const request = new Request(query,
                    (err, rowCount) => {
...
// SELECT * FROM [dbo].[saved_drinks_view] WHERE user_id = ${user_id}
server.route({
    method: 'GET',
    //Takes in user id as a param through path
    ...
    handler: async function (request, reply) {
        ...
        const query = `SELECT * FROM [dbo].[saved_drinks_view] WHERE user_id = ${user_id}`;
        console.log(query);
        return await new Promise((resolve, reject) => {
            const request = new Request(query,
                (err, rowCount) => {
    ...
    // SELECT * FROM [dbo].[drink_ingredients_view] WHERE drink_id=3
    //Post request test on test table
    server.route({
        method: 'GET',
        //Takes in user id as a param through path
        path: '/drinkIngredients/{drink_id}',
        handler: async function (request, reply) {
            const drink_id = request.params.drink_id;
            const query = `SELECT * FROM [dbo].[drink_ingredients_view] WHERE drink_id=${drink_id}`;
            console.log(query);
            return await new Promise((resolve, reject) => {
                const request = new Request(query,
                    (err, rowCount) => {
